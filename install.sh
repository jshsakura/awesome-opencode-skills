...
curl -sL https://github.com/jshsakura/awesome-opencode-subagents/archive/refs/heads/main.zip -o "$ZIP_FILE"
...
mkdir -p "$INSTALL_DIR"
cp -r "$TMP_DIR/awesome-opencode-subagents-main/skills/"* "$INSTALL_DIR/"
